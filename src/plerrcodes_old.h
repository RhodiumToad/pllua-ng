/*
 * From pg11 onwards, we use an autogenerated file in place of this. This copy
 * is stolen wholesale from plpgsql in pg10, except that the warning and
 * success codes were added (back) by hand and conditionals added to make it
 * work with 9.6 and 9.5.
 */
...
{
    "dynamic_result_sets_returned", ERRCODE_WARNING_DYNAMIC_RESULT_SETS_RETURNED
},
{
    "implicit_zero_bit_padding", ERRCODE_WARNING_IMPLICIT_ZERO_BIT_PADDING
},
{
    "null_value_eliminated_in_set_function", ERRCODE_WARNING_NULL_VALUE_ELIMINATED_IN_SET_FUNCTION
},
{
    "privilege_not_granted", ERRCODE_WARNING_PRIVILEGE_NOT_GRANTED
},
{
    "privilege_not_revoked", ERRCODE_WARNING_PRIVILEGE_NOT_REVOKED
},
{
    "string_data_right_truncation", ERRCODE_WARNING_STRING_DATA_RIGHT_TRUNCATION
},
{
    "deprecated_feature", ERRCODE_WARNING_DEPRECATED_FEATURE
},
{
