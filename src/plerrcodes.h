/* someday we will autogenerate this. but today is not that day */
/* for now it's just stolen wholesale from plpgsql in pg10, */
/* except that the warning and success codes were added by hand */
